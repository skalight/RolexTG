...
MELCOW_VID = environ.get("MELCOW_VID", "https://telegra.ph/file/5cdeb461424dd94546191.mp4")
SPELL_IMG = environ.get("SPELL_IMG", "https://telegra.ph/file/5e2d4418525832bc9a1b9.jpg")

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5296610774 1491400016').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001782441380').split()]
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/jailmoviehdbackup_08')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Jail_Linkzz')
MOVIE_GRP = environ.get('MOVIE_GRP', 'https://t.me/jailmoviehdbackup_08')
SERIES_GRP = environ.get('SERIES_GRP', 'https://t.me/Jail_Linkzz')
MAIN_CHNL = environ.get('MAIN_CHNL', 'https://t.me/Jail_Linkzz')
MSG_ALRT = environ.get('MSG_ALRT', '🚩 @Jail_Linkzz Best Channel In Telegram')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001654008278'))
REQUEST_LOGS = int(environ.get('REQUEST_LOGS', '-1001654008278'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Jail_Linkzz')
...
DOWNLOAD_TEXT_URL = "https://t.me/Jail_Linkzz"
CAPTION_BUTTON_URL = "https://t.me/Jail_Linkzz"
